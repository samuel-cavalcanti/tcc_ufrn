...
foi implementado o controlador Frederico e encontrado as constantes do P.I.D empiricamente.
...
são um sub conjunto do conjunto de testes. Foi calculado o erro quadrático
...
Como dito anteriormente foi utilizado o controlador Frederico,
