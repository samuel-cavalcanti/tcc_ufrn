...
class Coppeliasim:
    ...
    def reset_robot_pos(self) -> None:
        self.__sim.setObjectPosition(
            self.__robot.handle, -1, [0.0, 0.0, +6.4041e-01])
        self.__sim.setObjectOrientation(
            self.__robot.handle, -1, [0.0, -0.03490658503988659, 0.0])

    def set_robot_random_orientation(self):
        
        self.__sim.setObjectOrientation(
            self.__robot.handle, -1, [0.0, -0.03490658503988659, random.uniform(-3.14159265359,3.14159265359)])
